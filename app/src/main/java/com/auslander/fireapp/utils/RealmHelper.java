...
import com.auslander.fireapp.model.constants.FireCallDirection;
import com.auslander.fireapp.model.constants.MessageStat;
import com.auslander.fireapp.model.constants.MessageType;
import com.auslander.fireapp.model.realms.Broadcast;
import com.auslander.fireapp.model.realms.Chat;
import com.auslander.fireapp.model.realms.CurrentUserInfo;
import com.auslander.fireapp.model.realms.DeletedMessage;
import com.auslander.fireapp.model.realms.FireCall;
import com.auslander.fireapp.model.realms.Group;
import com.auslander.fireapp.model.realms.JobId;
import com.auslander.fireapp.model.realms.Message;
import com.auslander.fireapp.model.realms.PendingGroupJob;
import com.auslander.fireapp.model.realms.Status;
import com.auslander.fireapp.model.realms.StatusSeenBy;
import com.auslander.fireapp.model.realms.TempMessage;
import com.auslander.fireapp.model.realms.UnUpdatedStat;
import com.auslander.fireapp.model.realms.UnUpdatedVoiceMessageStat;
import com.auslander.fireapp.model.realms.User;
import com.auslander.fireapp.model.realms.UserStatuses;
...
*/
    ...
    public RealmResults<User> getListOfUsers() {
        return realm.where(User.class)
                ...
                .equalTo(DBConstants.IS_DELETED, false)
                .findAll()
    ...
    public void setUserDeleted(String userId, boolean b) {
        User user = getUser(userId);
        if (user == null) {
            return;
        }
        ...
        realm.executeTransaction(realm1 -> {
            user.setDeleted(b);
            user.setUserName(MyApp.context().getString(R.string.deleted));
            user.setPhone("");
            user.setPhoto("");
            user.setStatus("");
            user.setThumbImg("");
            user.setUserLocalPhoto("");
            user.setStoredInContacts(false);
        });
