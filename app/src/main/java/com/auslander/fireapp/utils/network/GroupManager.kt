...
import com.auslander.fireapp.extensions.*
import com.auslander.fireapp.model.constants.DBConstants
import com.auslander.fireapp.model.constants.GroupEventTypes
import com.auslander.fireapp.model.constants.GroupEventTypes.GROUP_CREATION
import com.auslander.fireapp.model.constants.GroupEventTypes.USER_ADDED
                ...
                .flatMap { snapshot ->
                    ...
                    if (snapshot.exists()) {
                        for (snap in snapshot.children) {
                            ...
                            val groupEvent = snap.getValue(GroupEvent::class.java)
