...
import com.auslander.fireapp.model.constants.NetworkType;
...
public class SharedPreferencesManager {
    ...
    public static boolean isDesktopEnabled() {
        return mSharedPref.getBoolean("dkpEnabled", false);
    }

    public static void setDesktopEnabled(boolean b) {
        mSharedPref.edit().putBoolean("dkpEnabled", b).apply();
    }
}
