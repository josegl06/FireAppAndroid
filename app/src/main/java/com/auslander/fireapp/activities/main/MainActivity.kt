package com.auslander.fireapp.activities.main
...
import com.auslander.fireapp.activities.*
import com.auslander.fireapp.activities.settings.SettingsActivity
import com.auslander.fireapp.adapters.ViewPagerAdapter
import com.auslander.fireapp.common.ViewModelFactory
import com.auslander.fireapp.common.extensions.findFragmentByTagForViewPager
import com.auslander.fireapp.events.ExitUpdateActivityEvent
import com.auslander.fireapp.extensions.observeValueEvent
import com.auslander.fireapp.fragments.BaseFragment
import com.auslander.fireapp.interfaces.FragmentCallback
import com.auslander.fireapp.interfaces.StatusFragmentCallbacks
import com.auslander.fireapp.job.DailyBackupJob
import com.auslander.fireapp.job.SaveTokenJob
import com.auslander.fireapp.job.SetLastSeenJob
import com.auslander.fireapp.model.realms.User
import com.auslander.fireapp.services.FCMRegistrationService
import com.auslander.fireapp.services.InternetConnectedListener
import com.auslander.fireapp.services.NetworkService
import com.auslander.fireapp.utils.*
import com.auslander.fireapp.utils.network.FireManager
import com.auslander.fireapp.views.dialogs.IgnoreBatteryDialog
import com.auslander.fireapp.views.sticker.StickerLoader
...
class MainActivity : BaseActivity(), FabRotationAnimation.RotateAnimationListener, FragmentCallback,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (FireManager.isLoggedIn() && SharedPreferencesManager.isUserInfoSaved()) {
            ContactUtils.deleteDeletedUsers().subscribe({}, {}).addTo(disposables)
        }
    ...
    private fun syncContacts() {
        disposables.add(ContactUtils.syncContacts(SharedPreferencesManager.isDesktopEnabled()).subscribe({
