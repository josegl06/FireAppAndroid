package com.auslander.fireapp.activities.main.status
...
import com.auslander.fireapp.activities.MyStatusActivity
import com.auslander.fireapp.activities.ViewStatusActivity
import com.auslander.fireapp.activities.main.MainActivity.Companion.CAMERA_REQUEST
import com.auslander.fireapp.activities.main.MainActivity.Companion.REQUEST_CODE_TEXT_STATUS
import com.auslander.fireapp.activities.main.MainViewModel
import com.auslander.fireapp.activities.main.status.StatusFragmentEvent.OnActivityResultEvent
import com.auslander.fireapp.activities.main.status.StatusFragmentEvent.StatusInsertedEvent
import com.auslander.fireapp.adapters.StatusAdapter
import com.auslander.fireapp.databinding.FragmentStatusBinding
...
import com.auslander.fireapp.views.HeaderViewDecoration
import com.auslander.fireapp.views.TextViewWithShapeBackground
...
class StatusFragment : BaseFragment(), StatusAdapter.OnClickListener {
    ...
    private fun initAdapter() {
        ...
        decor?.let {
            binding.rvStatus.addItemDecoration(it)
        }
