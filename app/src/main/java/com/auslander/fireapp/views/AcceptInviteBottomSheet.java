package com.auslander.fireapp.views;
...
import com.auslander.fireapp.adapters.PartialGroupUsersAdapter;
...
public class AcceptInviteBottomSheet extends BottomSheetDialogFragment {
    ...
    public void showData(User user, int usersCount) {
        ...
        com.auslander.fireapp.model.realms.Group group = user.getGroup();
        if (group != null) {
